...
if ($action == 'add') {
    if ($comp_value_count < COMPARE_VALUE_COUNT) {
		...
		$compare_warning = COMPARE_PRODUCTS_ADDED;
    } else {
        $compare_warning = COMPARE_ONETIME_ITEM_COMPARE;
    }
} 
