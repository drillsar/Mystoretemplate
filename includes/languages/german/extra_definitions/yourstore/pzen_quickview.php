...
define('PZEN_QUICK_VIEW_TEXT', 'Schnellansich');
...
define ( 'TEXT_ADD_YOUR_REVIEW', 'Kommentar schreiben');
define ( 'TEXT_QUICK_OVERVIEW', 'Kurzübersicht ');
define ( 'TEXT_ADDITIONAL_INFORMATION', 'Weitere Informationen');
define ( 'TEXT_PRODUCT_DESCRIPTION', 'Beschreibung');
define ( 'TEXT_PRODUCT_REVIEWS', 'Bewertungen');
define ( 'TEXT_PRODUCT_COMMENTS', 'Kommentare');
...
define('DG_CUSTOMER_REVIEWS_TITLE', 'Kundenrezensionen :');
define('TEXT_PRODUCT_AVAILABILITY', 'Verfügbarkeit :');
define('TEXT_PRODUCT_UNITS_IN_STOCK', 'Stück auf Lager :');
