...
// Global entries for the <html> tag
  define('HTML_PARAMS', 'dir="'.((get_pzen_options('theme_mode')==1)? "rtl" : "ltr").'" lang="es"');
...
// used for redeem code sidebox
  ...
  define('BOX_GV_REDEEM_INFO', 'Código de la Tarjeta Regalo: ');
...
// javascript messages
  ...
  define('ENTRY_NICK_DUPLICATE_ERROR', 'Ese nombre ya existe.');
  define('ENTRY_NICK_LENGTH_ERROR', 'El nombre debe tener un mínimo de ' . ENTRY_NICK_MIN_LENGTH . ' caracteres.');
  ...
  define('PREVNEXT_BUTTON_FIRST', '<span class="icon icon-chevron_left"></span> PRIMERA');
  ...
  define('PREVNEXT_BUTTON_LAST', 'ÚLTIMA <span class="icon icon-chevron_right"></span>');
...
// payment method is GV/Discount
  ...
  define('TEXT_INVALID_REDEEM_COUPON', 'Código de Cupón no válido');
...
// for all pages except where multiple add to cart is used:
    define('SUCCESS_ADDED_TO_CART_PRODUCT', '<div class="cartbox_overlay"><p>El producto ha sido añadido al carro</p><button class="close btn btn--ys btn--sm" aria-hidden="true" data-dismiss="alert" type="button">Seguir comprando</button>&nbsp;&nbsp;&nbsp;<a class="btn btn--ys btn--sm" href="'.zen_href_link(FILENAME_SHOPPING_CART, '', 'SSL').'">Ir a la página de compra</a> </div>');
// only for where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCTS', '<div class="cartbox_overlay"><p>El producto(s) seleccionado ha sido añadido al carro</p><button class="close btn btn--ys btn--sm" aria-hidden="true" data-dismiss="alert" type="button">Seguir comprando</button>&nbsp;&nbsp;&nbsp;<a class="btn btn--ys btn--sm" href="'.zen_href_link(FILENAME_SHOPPING_CART, '', 'SSL').'">Ir a la página de compra</a> </div>');
...
// Sale Maker Sale Price
  define('PRODUCT_PRICE_SALE', '<small>Venta</small>&nbsp;');
...
// error on checkout when $_SESSION['customers_id' does not exist in customers table
  ...
  define('TABLE_HEADING_SPECIALS_INDEX', 'Ofertas del mes');
...
define('PZEN_SIDEBAR_TITLE_CATEGORIES', 'Categorías');
define('HEADER_TITLE_ACCOUNT', 'Cuenta');
define('TABLE_HEADING_RANDOM_PRODUCTS', 'Productos al azar');
define('PZEN_BADGE_NEW', 'Nuevo');
define('PZEN_BADGE_SALE', 'Venta');
define('TEXT_QTY', 'CANT :');
define('TEXT_BACK', 'espalda');
define('TEXT_BACK_TO_TOP', 'Volver al inicio');
define('TEXT_DROP_MENU', 'menú');
define('TEXT_DROP_MENU_CLOSE', 'cerca');
define('TEXT_SEARCH_PLACEHOLDER_KEYWORD', 'Buscar tienda entera aquí ..');
define('TEXT_BANNER', 'bandera');
...
define('TEXT_SHOPPING_CART', 'Cesta de la compra');
define('TABLE_HEADING_UPDATE', 'actualización');
define('TABLE_HEADING_DELETE', 'borrar');
define('TEXT_PRODUCT_REVIEW', 'Revisión de productos');
define('TITLE_PRODUCT_DETAILS', 'Detalles del producto');
define('TEXT_READ_MORE', 'leer más');
define('TEXT_SEE_ALL', 'ver todo');
define('HEADING_CONTACTS_TEXT', 'contactos');
define('LABEL_CONTACTS_ADDRESS', 'dirección :');
define('LABEL_CONTACTS_PHONE', 'teléfono :');
define('LABEL_CONTACTS_FAX', 'fax :');
define('LABEL_CONTACTS_HOURS', 'horas :');
define('LABEL_CONTACTS_EMAIL', 'Email :');
define('HEADING_GET_IN_TOUCH_WIDTH_US', 'Póngase en contacto con EE.UU.');
define('TITLE_PREVIOUS_PRODUCT', 'anterior Producto');
define('TITLE_NEXT_PRODUCT', 'Siguiente Producto');
define('COMPARE_ONETIME_ITEM_COMPARE', 'solamente ' . COMPARE_VALUE_COUNT  . ' artículos se pueden comparar a la vez');
define('TEXT_DETAILS', 'detalles');
define('MESSAGE_PRODUCT_ACTIONS_HAS_SUCCESS', 'Acciones productos ha sido-éxito.');
define('ZC_AJAX_ERROR_TRY_AGAIN', 'Por favor, inténtelo de nuevo.');
