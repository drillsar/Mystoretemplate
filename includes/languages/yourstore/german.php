 ...
 * @version $Id: german.php 2016-05-16 01:47:29Z frank18 $
 */
...
define('HTML_PARAMS', 'dir="'.((get_pzen_options('theme_mode')==1)? "rtl" : "ltr").'" lang="de"');
}
...
define('PREVNEXT_BUTTON_FIRST', '<span class="icon icon-chevron_left"></span> Erste');
...
define('PREVNEXT_BUTTON_LAST', 'Letzte <span class="icon icon-chevron_right"></span>');
...
define('ERROR_FILE_NOT_REMOVEABLE', 'WARNUNG: Diese Datei konnte nicht gelöscht werde. Bitte entfernen Sie die Datei mit Hilfe von FTP, die Schreibrechte für diese Datei lassen ein entfernen der Datei nicht zu.');
...
// for all pages except where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCT', '<div class="cartbox_overlay"><p>Der Artikel wurde in den Warenkorb gelegt</p><button class="close btn btn--ys btn--sm" aria-hidden="true" data-dismiss="alert" type="button">Mit dem Einkaufen fortfahrens</button>&nbsp;&nbsp;&nbsp;<a class="btn btn--ys btn--sm" href="'.zen_href_link(FILENAME_SHOPPING_CART, '', 'SSL').'">Zum Warenkorb Seite</a> </div>');
// only for where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCTS', '<div class="cartbox_overlay"><p>Die ausgewählten Artikel wurden in den Warenkorb gelegt</p><button class="close btn btn--ys btn--sm" aria-hidden="true" data-dismiss="alert" type="button">Mit dem Einkaufen fortfahrens</button>&nbsp;&nbsp;&nbsp;<a class="btn btn--ys btn--sm" href="'.zen_href_link(FILENAME_SHOPPING_CART, '', 'SSL').'">Zum Warenkorb Seite</a> </div>');
...
define('PRODUCT_PRICE_SALE', '<small>Verkauf</small>&nbsp;');
...
define('ERROR_PRODUCT_STATUS_SHOPPING_CART_ATTRIBUTES','<br />Leider haben sich die gewünschten Optionen für diesen Artikel geändert.<br />Dieser Artikel ist aus Ihrem Warenkorb entfernt worden.');
...
define('TABLE_HEADING_SPECIALS_INDEX', 'Sonderangebote');
...
define('TEXT_AUTHORIZATION_PENDING_CHECKOUT', 'Checkout nicht verfügbar - ÜBERPRÜFUNG LÄUFT');
...
define('ERROR_TEXT_COUNTRY_DISABLED_PLEASE_CHANGE', 'Leider akzeptieren wir nicht länger Rechnungsadressen oder Lieferadressen in "%s".  Bitte ändern Sie diese Adresse, um fortzufahren.');
...
define('PZEN_SIDEBAR_TITLE_CATEGORIES', 'Kategorien');
define('HEADER_TITLE_ACCOUNT', 'Konto');
define('TABLE_HEADING_RANDOM_PRODUCTS', 'Zufallsprodukte');
define('PZEN_BADGE_NEW', 'Neu');
define('PZEN_BADGE_SALE', 'Verkauf');
define('TEXT_QTY', 'MENGE :');
define('TEXT_BACK', 'zurück');
define('TEXT_BACK_TO_TOP', 'Zurück zum Anfang');
define('TEXT_DROP_MENU', 'Menü');
define('TEXT_DROP_MENU_CLOSE', 'schließen');
define('TEXT_SEARCH_PLACEHOLDER_KEYWORD', 'Suchen Sie hier gesamten Laden ..');
define('TEXT_BANNER', 'Banner');
define('TEXT_BRAND', 'Marke');
define('TEXT_DELETE', 'löschen');
define('TEXT_SHIPPING_ADDRESS', 'Lieferadresse');
define('TEXT_BILLING_ADDRESS', 'Rechnungsadresse');
define('TEXT_SHOPPING_CART', 'Einkaufswagen');
define('TABLE_HEADING_UPDATE', 'Aktualisierung');
define('TABLE_HEADING_DELETE', 'löschen');
define('TEXT_PRODUCT_REVIEW', 'Produktbewertung');
define('TITLE_PRODUCT_DETAILS', 'Produktdetails');
define('TEXT_READ_MORE', 'Lesen Sie weiter');
define('TEXT_SEE_ALL', 'alle');
define('HEADING_CONTACTS_TEXT', 'Kontakte');
define('LABEL_CONTACTS_ADDRESS', 'Adresse :');
define('LABEL_CONTACTS_PHONE', 'Telefon :');
define('LABEL_CONTACTS_FAX', 'Fax :');
define('LABEL_CONTACTS_HOURS', 'Stunden :');
define('LABEL_CONTACTS_EMAIL', 'Email :');
define('HEADING_GET_IN_TOUCH_WIDTH_US', 'Nehmen Sie Kontakt mit US');
define('TITLE_PREVIOUS_PRODUCT', 'vorheriges Produkt');
define('TITLE_NEXT_PRODUCT', 'Nächstes Produkt');
define('COMPARE_ONETIME_ITEM_COMPARE', 'nur ' . COMPARE_VALUE_COUNT  . ' Im Vergleich können Elemente auf einmal sein');
define('TEXT_DETAILS', 'Details');
define('MESSAGE_PRODUCT_ACTIONS_HAS_SUCCESS', 'Aktionen Produkte has-been erfolgreich.');
define('ZC_AJAX_ERROR_TRY_AGAIN', 'Bitte versuchen Sie es erneut.');
