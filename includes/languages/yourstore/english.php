...
// Global entries for the <html> tag
  define('HTML_PARAMS','dir="'.((get_pzen_options('theme_mode')==1)? "rtl" : "ltr").'" lang="en"');
...
//text for sidebox heading links
  define('BOX_HEADING_LINKS', 'View more');
...
// javascript messages
  ...
  define('PREVNEXT_BUTTON_FIRST', '<span class="icon icon-chevron_left"></span> First');
  ...
  define('PREVNEXT_BUTTON_LAST', 'LAST <span class="icon icon-chevron_right"></span>');
...
// for all pages except where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCT', '<div class="cartbox_overlay"><p>Successfully added selected Product(s) to the cart ...</p><button class="close btn btn--ys btn--sm" aria-hidden="true" data-dismiss="alert" type="button">Continue Shopping</button>&nbsp;&nbsp;&nbsp;<a class="btn btn--ys btn--sm" href="'.zen_href_link(FILENAME_SHOPPING_CART, '', 'SSL').'">Go to cart page</a> </div>');
// only for where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCTS', '<div class="cartbox_overlay"><p>Successfully added selected Product(s) to the cart ...</p><button class="close btn btn--ys btn--sm" aria-hidden="true" data-dismiss="alert" type="button">Continue Shopping</button>&nbsp;&nbsp;&nbsp;<a class="btn btn--ys btn--sm" href="'.zen_href_link(FILENAME_SHOPPING_CART, '', 'SSL').'">Go to cart page</a> </div>');
...
// Sale Maker Sale Price
  define('PRODUCT_PRICE_SALE','<small>Sale</small>&nbsp;');
...
// error on checkout when $_SESSION['customers_id' does not exist in customers table
  ...
  define('TABLE_HEADING_SPECIALS_INDEX', 'SPECIALS');
  define('TABLE_HEADING_SPECIALS_INDEX_RELOADED', 'SPECIAL PRODUCTS');
  define('TABLE_HEADING_BESTSELLERS', 'BESTSELLERS');
...
// table headings for cart display and upcoming products
  ...
  define('TABLE_HEADING_PRODUCTS_IMAGE', 'Item Image');
  define('TABLE_HEADING_PRODUCTS_NAME', 'Item Name');
...
// extra product listing sorter
  ...
  define('PZEN_SIDEBAR_TITLE_CATEGORIES', 'Categories');
  define('HEADER_TITLE_ACCOUNT', 'Account');
  define('TABLE_HEADING_RANDOM_PRODUCTS', 'Random Products');
  define('PZEN_BADGE_NEW', 'New');
  define('PZEN_BADGE_SALE', 'Sale');
  define('TEXT_QTY', 'QTY :');
  define('TEXT_BACK', 'Back');
  define('TEXT_BACK_TO_TOP', 'Back to Top');
  define('TEXT_DROP_MENU', 'Menu');
  define('TEXT_DROP_MENU_CLOSE', 'Close');
  define('TEXT_SEARCH_PLACEHOLDER_KEYWORD', 'Search entire store here..');
  ...
  define('LABEL_CONTACTS_ADDRESS', 'Address :');
  define('LABEL_CONTACTS_PHONE', 'Phone :');
  define('LABEL_CONTACTS_FAX', 'Fax :');
  define('LABEL_CONTACTS_HOURS', 'Hours :');
  define('LABEL_CONTACTS_EMAIL', 'Email :');
  define('HEADING_GET_IN_TOUCH_WIDTH_US', 'GET IN TOUCH WITH US');
  define('TITLE_PREVIOUS_PRODUCT', 'Previous Product');
  define('TITLE_NEXT_PRODUCT', 'Next Product');
  define('COMPARE_PRODUCTS_ADDED', 'The product has been added in compare list.');
  define('COMPARE_ONETIME_ITEM_COMPARE', 'Only ' . COMPARE_VALUE_COUNT  . ' items can be compared at one time');
  define('TEXT_DETAILS', 'Details');
  define('MESSAGE_PRODUCT_ACTIONS_HAS_SUCCESS', 'Products Actions has been successfully.');
  define('ZC_AJAX_ERROR_TRY_AGAIN', 'Please try again.');
