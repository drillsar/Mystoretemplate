...
// Global entries for the <html> tag
  define('HTML_PARAMS','dir="'.((get_pzen_options('theme_mode')==1)? "rtl" : "ltr").'"" lang="fr"');
...
// javascript messages
  ...
  define('ENTRY_DATE_OF_BIRTH_ERROR', 'Votre date de naissance doit être au format suivant : MM/JJ/AAAA (ex: 05/21/1970)');
  define('ENTRY_DATE_OF_BIRTH_TEXT', '* (ex : 05/21/1970)');
  define('ENTRY_EMAIL_ADDRESS', 'Adresse Email : ');
  define('ENTRY_EMAIL_ADDRESS_ERROR', 'Votre adresse email doit contenir un minimum de ' . ENTRY_EMAIL_ADDRESS_MIN_LENGTH . ' caractères. Veuillez rectifier et réessayer.');
  ...
  define('ENTRY_NICK_DUPLICATE_ERROR', 'Ce surnom est déjà utilisé ! Veuillez en choisir un autre.');
  ...
  define('ENTRY_COUNTRY_ERROR', 'Vous devez sélectionner un pays dans la menu déroulant.');
  ...
  define('PREVNEXT_BUTTON_FIRST', '<span class="icon icon-chevron_left"></span> PREMIER');
  define('PREVNEXT_BUTTON_PREV', '<span class="icon icon-chevron_left"></span>');
  define('PREVNEXT_BUTTON_NEXT', '<span class="icon icon-chevron_right"></span>');
  define('PREVNEXT_BUTTON_LAST', 'DERNIER <span class="icon icon-chevron_right"></span>');
...
define('SUCCESS_ADDED_TO_CART_PRODUCT', '<div class="cartbox_overlay"><p>Produit ajouté au panier avec succès</p><button class="close btn btn--ys btn--sm" aria-hidden="true" data-dismiss="alert" type="button">Continuer vos achats</button>&nbsp;&nbsp;&nbsp;<a class="btn btn--ys btn--sm" href="'.zen_href_link(FILENAME_SHOPPING_CART, '', 'SSL').'">Aller au panier Page</a> </div>');
// only for where multiple add to cart is used:
define('SUCCESS_ADDED_TO_CART_PRODUCTS', '<div class="cartbox_overlay"><p>Produit(s) choisi(s) ajouté(s) au panier avec succès</p><button class="close btn btn--ys btn--sm" aria-hidden="true" data-dismiss="alert" type="button">Continuer vos achats</button>&nbsp;&nbsp;&nbsp;<a class="btn btn--ys btn--sm" href="'.zen_href_link(FILENAME_SHOPPING_CART, '', 'SSL').'">Aller au panier Page</a> </div>');
...
// Sale Maker Sale Price
  define('PRODUCT_PRICE_SALE','<small>Soldé</small>&nbsp;');
...
// error on checkout when $_SESSION['customers_id' does not exist in customers table
  ...
  define('TABLE_HEADING_SPECIALS_INDEX', 'Promotions du Mois');
...
define('TABLE_HEADING_RANDOM_PRODUCTS', 'Produits au hasard');
define('PZEN_BADGE_NEW', 'Nouveau');
define('PZEN_BADGE_SALE', 'Vente');
define('TEXT_QTY', 'qté :');
define('TEXT_BACK', 'arrière');
define('TEXT_BACK_TO_TOP', 'Haut de page');
define('TEXT_DROP_MENU', 'menu');
define('TEXT_DROP_MENU_CLOSE', 'proche');
define('TEXT_SEARCH_PLACEHOLDER_KEYWORD', 'Rechercher magasin entier ici ..');
define('TEXT_BANNER', 'bannière');
define('TEXT_BRAND', 'feu');
define('TEXT_DELETE', 'effacer');
define('TEXT_SHIPPING_ADDRESS', 'Adresse d\'expédition');
define('TEXT_BILLING_ADDRESS', 'Adresse de facturation');
define('TEXT_SHOPPING_CART', 'Panier');
define('TABLE_HEADING_UPDATE', 'mettre à jour');
define('TABLE_HEADING_DELETE', 'effacer');
define('TEXT_PRODUCT_REVIEW', 'Product Review');
define('TITLE_PRODUCT_DETAILS', 'détails du produit');
define('TEXT_READ_MORE', 'Lire la suite');
define('TEXT_SEE_ALL', 'Voir tous');
define('HEADING_CONTACTS_TEXT', 'Contacts');
define('LABEL_CONTACTS_ADDRESS', 'adresse :');
define('LABEL_CONTACTS_PHONE', 'téléphone :');
define('LABEL_CONTACTS_FAX', 'fax :');
define('LABEL_CONTACTS_HOURS', 'heures :');
define('LABEL_CONTACTS_EMAIL', 'émail :');
define('HEADING_GET_IN_TOUCH_WIDTH_US', 'GET IN TOUCH AVEC NOUS');
define('TITLE_PREVIOUS_PRODUCT', 'produit précédent');
define('TITLE_NEXT_PRODUCT', 'produit suivant');
define('COMPARE_PRODUCTS_ADDED', 'The product has been added in compare list.');
define('COMPARE_ONETIME_ITEM_COMPARE', 'seulement ' . COMPARE_VALUE_COUNT  . ' articles peuvent être comparés à un moment');
define('TEXT_DETAILS', 'détails');
define('MESSAGE_PRODUCT_ACTIONS_HAS_SUCCESS', 'Produits actions ont été avec succès.');
define('ZC_AJAX_ERROR_TRY_AGAIN', 'S\'il vous plaît essayer à nouveau.');
