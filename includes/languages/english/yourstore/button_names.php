...
define('BUTTON_NEXT_ALT', 'next&nbsp;<i class="fa fa-angle-right"></i>');
define('BUTTON_PREVIOUS_ALT', '<i class="fa fa-angle-left"></i>&nbsp;prev');
define('BUTTON_REDEEM_ALT', 'Redeem');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Product List');
define('BUTTON_REVIEWS_ALT', 'Go to Reviews Page');
