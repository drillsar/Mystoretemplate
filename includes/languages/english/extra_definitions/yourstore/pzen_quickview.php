...
define('PZEN_QUICK_VIEW_TEXT', 'Quick View');
...
define('TEXT_ADD_YOUR_REVIEW', 'Add Your Review');
define('TEXT_QUICK_OVERVIEW', 'Quick Overview');
...
define('TEXT_PRODUCT_UNITS_IN_STOCK', 'Units in Stock :');
