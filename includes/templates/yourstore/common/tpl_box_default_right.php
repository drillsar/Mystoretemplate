...
?>
<!--// bof: <?php echo $box_id; ?> //-->
<div class="rightBoxContainer facet-box collapse-block open" id="<?php echo str_replace('_', '-', $box_id ); ?>">
<h4 class="rightBoxHeading collapse-block__title" id="<?php echo str_replace('_', '-', $box_id) . 'Heading'; ?>"><?php echo $title; ?></h4>
