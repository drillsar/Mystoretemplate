			...
			<div class="responsive-menu" id="mainMenu">									
				...
				<ul class="nav navbar-nav mn1">
					...
					<?php
						...
						$manufacturers_query = "SELECT m.manufacturers_id, m.manufacturers_name, m.manufacturers_image FROM ".DB_PREFIX."manufacturers m GROUP BY m.manufacturers_id ORDER BY m.manufacturers_name" ;
								...
								while (!$manufacturers->EOF) {
									...
									$manufacturers_name=$manufacturers->fields['manufacturers_name'];
										if($manufacturers_name !='' ) { ?>
											<li><a href="<?php echo zen_href_link("index&manufacturers_id=".$manufacturers_id."&pg=brands",'', 'SSL'); ?>">
