...
?>
 ...
 echo '<div id="product-area" class="section offer products-container portrait product-grid pzen-prod-list '.$pzengrid_class.'" data-layout="grid" '.$pzengrid_data.'>';
} ?>
<?php if($pzengrid_data=''){ ?>
