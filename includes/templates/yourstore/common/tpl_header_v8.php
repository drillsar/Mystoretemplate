				...
				<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 visible-mobile-menu-on">						
					<div class="settings">
						...
						<div class="currency dropdown text-left">
							<a data-toggle="dropdown" class="dropdown-toggle"><?php echo $_SESSION['currency']; ?><span class="caret"></span></a>
						...
						<div class="language dropdown text-left">
							<a class="dropdown-toggle" data-toggle="dropdown"><?php echo $_SESSION['language']; ?><span class="caret"></span></a>
							<ul class="dropdown-menu dropdown-menu--xs-full">
