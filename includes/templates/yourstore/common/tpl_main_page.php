		...
		<section class="breadcrumbs <?php echo (in_array($header_style,array('header_style_2','header_style_3','header_style_6','header_style_7','header_style_9')))? "no-border" : ''; ?>">
			<div class="<?php echo $container_class; ?>">
				<div class="breadcrumb-inner">
					<ol class="breadcrumb breadcrumb--ys pull-left"><?php echo str_replace('<a href="' . HTTP_SERVER . DIR_WS_CATALOG . '">' . HEADER_TITLE_CATALOG . '</a>','<li class="home-link"><a href="' . HTTP_SERVER . DIR_WS_CATALOG . '">' . HEADER_TITLE_CATALOG . '</a></li>',$breadcrumb->trail("<li>")); ?></ol>
				</div>
            </div>
		</section>
