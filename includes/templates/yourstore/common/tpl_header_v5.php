		...
		<header id="header" class="<?php echo $header_class; ?>">
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-3">
						<!-- logo start --> 
						<a href="<?php echo zen_href_link(FILENAME_DEFAULT, '', 'SSL'); ?>"><img class="logo img-responsive" alt="<?php if($logo_image!=NULL){ echo "logo"; } ?>" src="<?php echo $template->get_template_dir('',DIR_WS_TEMPLATE, $current_page_base,'images').'/uploads/'.$logo_image;?>" /></a> 
						<!-- logo end --> 
					</div>
										...
										<ul>
											...
											<li>
												<a href="<?php echo zen_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL'); ?>">
													<?php echo TEXT_AJAX_CART_CHECKOUT; ?>
												</a>
											</li>
											<li>
												<?php if (isset($_SESSION['customer_id'])) { ?>
