...
<div class="centerColumn" id="reviewsWrite">
	<div class="title-box">
    	<h2 class="title-under text-uppercase text-center"><?php echo $products_name; ?></h2>
   	</div>
    ...
    <div class="row">
		...
		<div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
        	<div class="card card--padding">
                ...
                <span id="reviewsWriteReviewer" class="">
                ...
                <div class="review-links">
                    <div id="reviewsWriteProductPageLink" class="buttonRow">
                            <?php echo '<a class="btn btn--ys" href="' . zen_href_link(zen_get_info_page($_GET['products_id']), zen_get_all_get_params(), 'SSL') . '">' . 
                    zen_image_button(BUTTON_IMAGE_GOTO_PROD_DETAILS , BUTTON_GOTO_PROD_DETAILS_ALT) . '</a>'; ?>
                    </div>
                    <div id="reviewsWriteReviewPageLink" class="buttonRow"><?php echo '<a class="btn btn--ys" href="' . zen_href_link(FILENAME_REVIEWS, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_REVIEWS, BUTTON_REVIEWS_ALT) . '</a>'; ?>
                    </div>
                </div>
			</div>
        </div>
