 ...
 */
?>
<div class="centerColumn product-container" id="productMusicDisplay">
    	...
    	<div class="row product-info-outer">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
              ...
              <div class="product-info__sku">
							...
							<div class="product-info__sku">
								<?php echo (($flag_show_product_info_quantity == 1) ? TEXT_PRODUCT_UNITS_IN_STOCK . '<strong>&nbsp;' . $products_quantity . '</strong>'  : '') . "\n"; ?>
							</div>
              <div class="product-info__sku">
                <?php echo (($flag_show_product_music_info_artist == 1 and !empty($products_artist_name)) ?  TEXT_PRODUCT_ARTIST . '<strong>&nbsp;' . $products_artist_name . '</strong>' : '') . "\n"; ?>
              </div>
              <div class="product-info__sku">
                <?php echo (($flag_show_product_music_info_genre == 1 and !empty($products_music_genre_name)) ? TEXT_PRODUCT_MUSIC_GENRE . '<strong>&nbsp;' . $products_music_genre_name . '</strong>' : '') . "\n"; ?>
              </div>
							...
							?>
							  <div id="productDateAvailable" class="productMusic product-info__sku"><?php echo sprintf(TEXT_DATE_AVAILABLE, '<strong>' . zen_date_long($products_date_available) . '</strong>'); ?></div>
							<?php
								}
							  } else {
								if ($flag_show_product_info_date_added == 1) {
							?>
								<div id="productDateAdded" class="productMusic product-info__sku"><?php echo sprintf(TEXT_DATE_ADDED,  '<strong>' . zen_date_long($products_date_added)  . '</strong>' ); ?></div>
							<?php
						...
						<?php
							...
							if (MODULE_WISHLISTS_ENABLED) { $wishlist_link= '<a title="'.TEXT_ADD_WISHLIST.'" href="' . zen_href_link(FILENAME_WISHLIST, 'products_id=' . $_GET['products_id'] . '&action=wishlist_add_product', 'SSL') . '"><span class="icon icon-favorite_border  tooltip-link"></span><span class="text">'.TEXT_ADD_WISHLIST.'</span></a>';}else{ $wishlist_link='';}
