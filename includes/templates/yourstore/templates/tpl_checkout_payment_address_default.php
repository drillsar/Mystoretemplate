...
<div class="centerColumn" id="checkoutPayAddressDefault">
    ...
    <div class="title-box">
        <h2 id="checkoutPayAddressDefaultHeading" class="text-center text-uppercase title-under"><?php echo HEADING_TITLE; ?></h2>
    </div>
    ...
    <div class="row checkout-shipping-button">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-7">
			...
			<br><br>
			<div class="buttonRow back clearBoth">
				<?php echo '<a class="btn--ys" href="' . zen_back_link(true)  . '">' . zen_image_button(BUTTON_IMAGE_BACK, BUTTON_BACK_ALT) . '</a>'; ?>
            </div>
        </div>
