...
<div class="centerColumn" id="addressBookProcessDefault">
	...
	<div class="title-box">
		<h2 class="title-under text-uppercase text-center"><?php if (isset($_GET['edit'])) { echo HEADING_TITLE_MODIFY_ENTRY; } elseif (isset($_GET['delete'])) { echo HEADING_TITLE_DELETE_ENTRY; } else { echo HEADING_TITLE_ADD_ENTRY; } ?></h2>
	</div>
    ...
    <div class="card card--padding">
		...
		<address><?php echo zen_address_label($_SESSION['customer_id'], $_GET['delete'], true, ' ', '<br />'); ?></address>
 		<div class="buttonRow forward">
			...
			<?php echo '<a class="btn btn--ys" href="' . zen_href_link(FILENAME_ADDRESS_BOOK, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_BACK, BUTTON_BACK_ALT) . '</a>'; ?>
			</form>
		</div>
	</div>		
	<?php
