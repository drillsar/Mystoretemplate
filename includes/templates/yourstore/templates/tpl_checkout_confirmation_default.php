...
<div class="centerColumn" id="checkoutConfirmDefault">
	<div class="title-box">
		...
		<h2 id="checkoutConfirmDefaultHeading" class="current-step text-center text-uppercase title-under"><?php echo HEADING_TITLE; ?></h2>
	</div>
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 payment-address-content">
		    	...
		    	<?php if (!$flagDisablePaymentAddressChange) { ?>
        			<div class="buttonRow forward change_address">
						<?php echo '<a class="btn btn--ys btn--sm" href="' . zen_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL') . '">' . BUTTON_CHANGE_ADDRESS_ALT. '</a>'; ?>
        			</div>
        		<?php } ?>
    		</div>
			<?php
			...
			?>
     		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 billing-address-content">
        		...
        		<address><?php echo zen_address_format($order->delivery['format_id'], $order->delivery, 1, ' ', '<br />'); ?></address>
	     		<div class="buttonRow forward change_address">
					<?php echo '<a class="btn btn--ys btn--sm" href="' . $editShippingButtonLink . '">' . BUTTON_CHANGE_ADDRESS_ALT. '</a>'; ?>
                </div>
	 		</div>
			<?php } ?>
    	</div>
      	...
      	<div class="table-responsive">
			<table class="table table-bordered" width="100%" cellspacing="0" cellpadding="0" id="cartContentsDisplay">
				<tr class="cartTableHeading">
					...
					<th scope="col"> <?php echo BUTTON_EDIT_SMALL_ALT; ?> </th>
				</tr>
					...
					?>
					 ...
					 <td>
						<div class="buttonRow forward">
							<?php echo '<a class="table_edit_button btn btn--ys btn--xs btn--light" href="' . zen_href_link(FILENAME_SHOPPING_CART, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_EDIT_SMALL, BUTTON_EDIT_SMALL_ALT) . '</a>'; ?>
						</div>
					 </td>
				</tr>
