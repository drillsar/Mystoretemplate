...
<?php require($template->get_template_dir('tpl_index_default.php',DIR_WS_TEMPLATE, $current_page_base,'templates'). '/tpl_index_default.php'); ?>
<?php }else{ ?>
<div class="centerColumn" id="indexCategories">
	...
	?>
	<div  id="categoryDescription" class="catDescContent offset-top-20">
			<?php
...
<?php if ($show_display_category->fields['configuration_key'] == 'SHOW_PRODUCT_INFO_CATEGORY_BEST_SELLERS') { ?>
...
<?php if($saf_display_style=='default') { ?>
