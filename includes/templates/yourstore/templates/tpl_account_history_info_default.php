...
<div class="centerColumn" id="accountHistInfo">
	<div class="title-box">
		<h2 class="title-under text-uppercase text-center"><?php echo HEADING_ORDER_DATE . ' ' . zen_date_long($order->info['date_purchased']); ?></h2>
	</div>
	<div class="card card--padding">
    	<div class="table-responsive">
            <table border="0" width="100%" cellspacing="0" cellpadding="0" class="table table-bordered">
                <caption>
                    <h4>
        ...
        <div id="cartSubTotal">
			...
			<div class="product_price total">
				<strong><?php echo $order->totals[$i]['title'] ?></strong>
				<div style="display: inline-block"><span class="total_price"><?php echo $order->totals[$i]['text'] ?></span></div>
			</div>
			<?php
              }
            ?>
	...
	<div class="card card--padding">
    	<div class="table-responsive">
			<table class="table table-bordered" border="0" width="100%" cellspacing="0" cellpadding="0" id="myAccountOrdersStatus">
				<caption>
