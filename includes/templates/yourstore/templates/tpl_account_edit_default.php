...
<div class="centerColumn" id="accountEditDefault">
	...
	<div class="next-prev">
        ...
        <div class="buttonRow back change_address"><?php echo '<a class="btn btn--ys" href="' . zen_href_link(FILENAME_ACCOUNT, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_BACK , BUTTON_BACK_ALT) . '</a>'; ?></div>
    </div>
</form>
</div>