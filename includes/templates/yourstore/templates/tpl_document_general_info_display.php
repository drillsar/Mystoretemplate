 ...
 */
?>
<div class="centerColumn product-container" id="docGeneralDisplay">
				...
				<div class="row <?php echo ($prodinfo_image_layout==1)? 'big-size' : 'small-size'; ?> product-view">
				  <?php	if (zen_not_null($products_image)) { ?>
					...
					<div class="product-info <?php echo ($prodinfo_image_layout==1)? 'col-sm-6 col-md-6 col-lg-6 col-xl-6' : 'col-sm-8 col-md-8 col-lg-8 col-xl-8'; ?>">
						...
						<?php } ?>
						<!--eof free ship icon  -->
						<div id="productPrices" class="docGeneral price-box product-info__price">
							<?php
								// base price
						...
						<div class="product-info__description hidden-xs">
							...
							?>
							  <div id="productDateAvailable" class="docGeneral product-info__sku"><?php echo sprintf(TEXT_DATE_AVAILABLE, '<strong>' . zen_date_long($products_date_available) . '</strong>'); ?></div>
							<?php
								}
							  } else {
								if ($flag_show_product_info_date_added == 1) {
							?>
								<div id="productDateAdded" class="docGeneral product-info__sku"><?php echo sprintf(TEXT_DATE_ADDED,  '<strong>' . zen_date_long($products_date_added)  . '</strong>' ); ?></div>
							<?php
