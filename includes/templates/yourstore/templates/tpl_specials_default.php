...
<div class="centerColumn" id="specialsListing">
	...
	<div class="pageresult_top filters-row">
		...
		<div class="product-page-count">
			<div class="speciallisting_number_links special_toplinks">
				<div id="specialsListingTopNumber" class="navSplitPagesResult back">
		...
		<div id="specialsListingBottomLinks" class="navSplitPagesLinks forward filters-row__pagination">
			<ul class="pagination">
				<?php echo TEXT_RESULT_PAGE . ' ' . $specials_split->display_links(MAX_DISPLAY_PAGE_LINKS, zen_get_all_get_params(array('page', 'info', 'x', 'y', 'main_page')), $paginateAsUL); ?>
			</ul>
		</div>
		<?php
		} ?>
...
<div class="pageresult_bottom filters-row">
    ...
    <div class="product-page-count">
		<div class="speciallisting_number_links special_bottomlinks">
			<div id="specialsListingBottomNumber" class="navSplitPagesResult back">
				<?php echo $specials_split->display_count(TEXT_DISPLAY_NUMBER_OF_SPECIALS); ?>
            </div>
    	</div>
   	</div>
