...
<?php echo zen_draw_form('checkout_address', zen_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL')) . zen_draw_hidden_field('action', 'process'); ?>
	<div class="title-box">
		<h2 id="checkoutShippingHeading" class="text-center text-uppercase title-under current-step">
	...
	<div class="card card--padding">
		...
		<div class="row checkoutshipping-content">
			<div id="checkoutShipto" class="col-lg-6 col-md-6 col-sm-6 col-xs-12 shipping-address">
				<span class="add_title"><?php echo TEXT_SHIPPING_ADDRESS; ?></span>
            	...
            	<div class="buttonRow forward change_address">
					<?php echo '<a class="btn btn--ys btn--sm" href="' . $editShippingButtonLink . '">' . zen_image_button(BUTTON_IMAGE_CHANGE_ADDRESS, BUTTON_CHANGE_ADDRESS_ALT) . '
				</a>'; ?>
                </div>
			</div>
