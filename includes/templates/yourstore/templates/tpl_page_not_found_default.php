...
<div class="title-box">
	<h2 id="pageNotFoundHeading" class="text-center text-uppercase title-under"><?php echo HEADING_TITLE; ?></h2>
</div>
...
<?php } ?>
	<div class="home_button">
    	<div class="buttonRow back button">
			<a href="<?php echo zen_href_link(FILENAME_DEFAULT."&pg=home", '', 'SSL'); ?>"><?php echo 'Go ' . HEADER_TITLE_CATALOG; ?></a>
    	</div>
	</div>
</div>
