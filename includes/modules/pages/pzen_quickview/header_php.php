 ...
 */
  ...
  if ( $res->fields['total'] < 1 ) {
    ...
    $tpl_page_body = '/tpl_pzen_product_quickview.php';
...
// if review must be approved or disabled do not show review
  ...
  $products_description = (!preg_match('/(<br|<p|<div|<dd|<li|<span)/i', $product_info->fields['products_description']) ? nl2br($product_info->fields['products_description']) :
  $product_info->fields['products_description']);
  
  if(strlen($products_description) > 350){
...
require(DIR_WS_MODULES.'pages/'.$current_page_base.'/jscript_dynamic_price_updater.php');
require(DIR_WS_MODULES.'pages/'.$current_page_base.'/jscript_custom.php');
  // get html
ob_start();
