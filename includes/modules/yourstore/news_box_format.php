...
$news_box_query_raw = "SELECT n.box_news_id, nc.news_title, nc.news_content, nc.news_image, n.news_added_date, n.news_modified_date, n.news_start_date, n.news_end_date
                        ...
                        WHERE n.news_status = 1 
                          ...
                          AND ( n.news_end_date = '0001-01-01 00:00:00' OR  n.news_end_date = '0000-00-00 00:00:00' OR now() <= n.news_end_date)
