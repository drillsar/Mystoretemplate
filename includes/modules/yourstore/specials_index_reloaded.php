...
$master_category_id = $featured_category_2;
...
if ($num_products_count > 0) {
  ...
  $list_box_contents = array();
	while (!$specials_index->EOF) {
		...
		$list_box_contents[$row][$col] = array('params' => 'class="col-lg-3 centerBoxContentsSpecialsReloaded centerBoxContentsSpecials product-item back"' . ' ', 'text' => (($specials_index->fields['products_image'] == '' and PRODUCTS_IMAGE_NO_IMAGE_STATUS == 0) ? '' : 
